...
const ELEMENT_GROUPS = {
  'Li': 'alkali-metal','Na': 'alkali-metal','K': 'alkali-metal','Rb': 'alkali-metal',
  'Cs': 'alkali-metal',
  'Fr': 'alkali-metal',
  'Be': 'alkaline-earth','Mg': 'alkaline-earth','Ca': 'alkaline-earth','Sr': 'alkaline-earth','Ba': 'alkaline-earth','Ra': 'alkaline-earth',
  'He': 'noble-gas','Ne': 'noble-gas','Ar': 'noble-gas','Kr': 'noble-gas','Xe': 'noble-gas','Rn': 'noble-gas',
  'F': 'halogene','Cl': 'halogene','Br': 'halogene','I': 'halogene',
  'C': 'chnopss','H': 'chnopss','N': 'chnopss','O': 'chnopss','P': 'chnopss','S': 'chnopss','Se': 'chnopss',
  'B': 'metalloid','Si': 'metalloid','Ge': 'metalloid','Sb': 'metalloid','As': 'metalloid','Te': 'metalloid','At': 'metalloid',
  'Zn': 'metal','Cd': 'metal','Hg': 'metal','Al': 'metal','Ga': 'metal','In': 'metal','Tl': 'metal','Sn': 'metal','Pb': 'metal','Bi': 'metal','Po': 'metal',
  'Sc': 'metal-transition',
  'Ti': 'metal-transition',
  'V': 'metal-transition',
  'Cr': 'metal-transition',
